...
<div id="encabezado">
        ...
        <div id="contenido">
            ...
            <?php if (isset($cod_fam) && count($stock) != 0): // Si tengo codigo enviado y no esta vacio ?>
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <?php endforeach; ?>
                 <input type="hidden" name="cod_prod" value="<?= $cod_fam ?>">
